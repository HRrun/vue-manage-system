    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 平台账户管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$addr.post("/platform-account/list/get", {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$addr.post("/platform-account/delete", {
                            ids: this.delList
                        }).then((res) => {
            ...
            saveEdit() {
                ...
                if (this.edit.branch.split(" ").join("").length !== 0) {
                    param.branch = this.edit.branch;
                }
                if (this.edit.account.split(" ").join("").length !== 0) {
                    param.account = this.edit.account;
                }
                this.$addr.post("/platform-account/"+ this.form.id +"/update", param).then((res) => {
            ...
            addUser() {
                ...
                this.$addr.post("/platform-account/add", {
